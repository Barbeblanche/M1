...
data_para_acc <- data.frame(read.csv2(file="fichiers_thread/exec_thread_acc_2.txt",sep=';', dec='.'))
data_para_eff <- data.frame(read.csv2(file="fichiers_thread/exec_thread_eff_2.txt",sep=';', dec='.'))
